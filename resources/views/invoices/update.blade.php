<x-layoutmain>
    ...
    <div class="flex flex-col bg-blue-400 flex-grow px-1">
        ...
        <div class="flex flex-row self-center ">Update Invoice</div>

        <div class="flex flex-row self-center">
            <form action="/{{ "invoices/".$invoice->id }}" method="POST" class="bg-amber-200 p-2 ">
                @csrf
                @method('PATCH') 
                ...
                <input id='titlex' name="title" type="text" class="bg-amber-50" value="{{ $invoice->title }}" >
                </div>
                ...
                <input id='fromx' name="from" type="text" class="bg-amber-50" value="{{ $invoice->from }}"> 
                </div>
                <div class="mb-4">
                    @error('from')
                        <div class="text-red-500 mt-2 text-sm">
                ...
                <input id='tox' name="to" type="text" class="bg-amber-50" value="{{ $invoice->to }}">
                </div>
                <div class="mb-4">
                    @error('to')
                        <div class="text-red-500 mt-2 text-sm">
                ...
                <div class="flex flex-row self-center">
                    <input id="" type="submit" name="update"
